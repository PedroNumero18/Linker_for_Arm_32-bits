...
- tout les bugs présent (connue) sont du au fait que linker.c n'est pas terminée 

## Liste et description des tests effectués
Liste de fichiers à tester :
Pour tester les programmes, nous avons créé 3 fichiers ARM 32 bits big endian supplémentaires :
